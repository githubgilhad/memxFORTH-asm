...
//	#define STR_2MORE "»" // 0xC2 0xBB);//'»'
	...
	#define BIOS_LINES		25					// number of rows of VGA text output
	#define BIOS_COLUMNS		40					// number of columns of VGA text output (more than 37 means noise from PS/2 input)

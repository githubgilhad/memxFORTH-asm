...
#define FF_USE_CHMOD	1	// %%% chci nastavovat cas souboru
...
#define FF_CODE_PAGE	852	// %%% Latin 2
...
#define FF_FS_TINY		1	// %%% Tiny, should bee enought for per block file reading
...
#define FF_FS_CRTIME	1	// %%% timestamp
